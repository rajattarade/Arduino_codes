...
avgy=avgy/range;
  ...
  Serial.print("#FIL:");             //Filtered angle
  Serial.print(avgx);
  Serial.print(F(","));
  Serial.print(avgy);
  Serial.print(F(","));
  ...
  Serial.print(F("\t"));
    ...
    if(avgx>0.5)
  {
    Serial.println("X clock");
    digitalWrite(EN,LOW);
    delay(1);
    step(true, Y_DIR, Y_STP, 2); //Y, Clockwise
    digitalWrite(EN,HIGH);
    //delay(100);
  }
  if(avgx<-0.5)
  {
    Serial.println("X counterclk");
    digitalWrite(EN,LOW);
    delay(1);
    step(false, Y_DIR, Y_STP, 2); //Y, Clockwise
    digitalWrite(EN,HIGH);
    //delay(100);
  }
  ...
  if(avgy>0.5)
  {
    Serial.println("Y clock");
    digitalWrite(EN,LOW);
    delay(1);
    step(false, X_DIR, X_STP, 2); //Y, Clockwise
    digitalWrite(EN,HIGH);
    //delay(100);
  }
  if(avgy<-0.5)
  {
    Serial.println("Y counterclk");
    digitalWrite(EN,LOW);
    delay(1);
    step(true, X_DIR, X_STP, 2); //Y, Clockwise
    digitalWrite(EN,HIGH);
    //delay(100);
  }
  else
