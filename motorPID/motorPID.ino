...
#define MOTOR_PINA 2 //For HCMODU0033 connect to A-IA, for HCARDU0013 connect to IN1
#define MOTOR_PINB 3 //For HCMODU0033 connect to A-IB, for HCARDU0013 connect to IN2
